...
#Selecciono menos datos para probar mi implementacion
#data_Do=data_Do[0:1000]
#data_Sol=data_Sol[0:1000]
...
def filtro_ampl(datos,freq):
	...
	for j in range(contador_fftx-60,contador_fftx+60):
		ampl[j] = 0
	for k in range(rm_22-60,rm_22+60):
		ampl[k] = 0	
...
son[2].set_xlabel("Frecuencia(Hz)")
son[2].legend()
plt.suptitle("Do-Sol")
